...
mod bmp_tests{
    ...
    #[test]
    fn test_bmp_lsb_retrieve_large(){
        ...
        match bmp_image_parser.pixel_size {
            3 => {
                data_vec = extract_lsb_data::<RgbPixel>( &mut bmp_image_parser.file_data[bmp_image_parser.pixel_map.pixel_map_start as usize..], bmp_image_parser.pixel_map.width as u64, bmp_image_parser.pixel_map.height as u64, bmp_image_parser.padding_size as u64, bmp_image_parser.pixel_size as u64,(message_vec.len() * 8) as u64);
            }

            4 => {
                data_vec = extract_lsb_data::<RgbaPixel>(&mut bmp_image_parser.file_data[bmp_image_parser.pixel_map.pixel_map_start as usize..], bmp_image_parser.pixel_map.width as u64, bmp_image_parser.pixel_map.height as u64, bmp_image_parser.padding_size as u64, bmp_image_parser.pixel_size as u64, (message_vec.len() * 8) as u64);
            }
            _ => {
                println!("bmp test.rs Got bad value for pixel size, exiting ...");
                exit(1);
